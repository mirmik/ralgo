...
static inline
int setvel(dof6_controller * axctr, int argc, char ** argv, char * output, int outmax)
{
	if (argc < 1)
	{
...
static inline
int setacc(dof6_controller * axctr, int argc, char ** argv, char * output, int outmax)
{
	if (argc < 1)
	{
		snprintf(output, outmax, "Need argument");
...
static inline
int setdcc(dof6_controller * axctr, int argc, char ** argv, char * output, int outmax)
{
	if (argc < 1)
	{
		snprintf(output, outmax, "Need argument");
...
/*static inline
int absmove(dof6_controller * axctr, int argc, char ** argv, char * output, int outmax)
{
	if (argc < 6)
	{
		snprintf(output, outmax, "Need argument");
	...
	axctr->absmove(atof(argv[0]), atof(argv[1]), atof(argv[2]), atof(argv[3]), atof(argv[4]), atof(argv[5]));
	return 0;
}*/
