...
namespace ralgo
{
	namespace heimer
	{
		...
		{
			igris::array_view<axis_driver<P, V>*> axes;
			igris::array_view<interpolation_group<P, V>*> igroups;

		public:
			command_center_cls() {}

		public:
			void attach_axes(igris::array_view<axis_driver<P, V>*> axes) { this->axes = axes; }
			void attach_igroups(igris::array_view<interpolation_group<P, V>*> igroups) { this->igroups = igroups; }
		...
		extern ralgo::heimer::command_center_cls<float, float> command_center;
