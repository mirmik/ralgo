...
int heimer::command_center_console::help(int argc, char ** argv) 
{
    ...
    printf(
        "DataNodes managment:\n"
        "      addsignal       add signal datanode. usage: addsignal NAME TYPEHINT\n"
        "      delsignal       del signal datanode. usage: delsignal NAME\n"
        "      listsigs        print signal datanodes list\n"
        " \n"
        "Nodes managment:\n"
        "      addnode         add signal worker node. usage: addnode NODENAME TYPEHINT\n"
        "      delnode         del signal worker node. usage: delnode NODENAME\n"
        "      listnodes       print signal nodes list\n"
        "      info            print node info. usage: info NODENAME\n"
        "      nodecmd         control node. usage: nodecmd NODENAME [OPTS...]\n"
        "\n"
    );
