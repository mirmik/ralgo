...
heimer::signal_head * heimer::axstate_pid_processor::iterate_left(heimer::signal_head * iter)
{
	return iter == nullptr ? state : nullptr;
}

heimer::signal_head * heimer::axstate_pid_processor::iterate_right(heimer::signal_head * iter)
{
