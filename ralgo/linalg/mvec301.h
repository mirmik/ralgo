...
namespace ralgo 
{
	...
	public:
		...
		{
			return mvec3{
				s*oth.s + t*oth.t + linalg::dot(v,oth.v) + linalg::dot(b,oth.b),
				s*oth.v + t*oth.b + v*oth.s + b*oth.t,
				s*oth.b + t*oth.v + b*oth.s + v*oth.t,
				s*oth.t + t*oth.s + linalg::dot(v,oth.b) + linalg::dot(b,oth.v)
			};
		} 
	}
	...
	class rvec301 
	{
		...
		{
			return rvec301 {
				s*oth.s + linalg::dot(b,oth.b) + 0 + 0,
				s*oth.b + b*oth.s + linalg::cross(b,oth.b)
				s*oth.dv + dv*oth.s + 
				s*oth.dt + linalg::dot(b,oth.dv) + linalg::dot(oth.dv, b) + 
			};
		} 
	}
}
