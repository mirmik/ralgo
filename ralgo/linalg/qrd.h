...
{
    /**
     *  QRD разложение или QRD ортоганализация. Выполняется над квадратной матрицей
     *  путём последовательного выбора векторов и доворота их до ортогонального состояния.
     *  На выходе алгоритма - ортогональная матрица Q и диагональная матрица R. 
     */
