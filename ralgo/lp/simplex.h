...
{
	/**
	 *  Симплексом называется выпуклая линейная оболочка натянутая в пространстве
	 *  на минимальное количество вершин.
	 *  Для пространства размерности N количество вершин равно N + 1.
	 */
	class simplex 
	{
	...
	public:
		...
		/// Перевод кординат из евклидового пространства-N в барицентрические координаты симплекса.
		/// Перевод осуществляется путём решения уравнения 
		/// | x1 x2 x3 | | l1 |   | x |
		/// | y1 y2 y3 | | l2 | = | y |     ( N=2 )
		/// |  1  1  1 | | l3 |   | 1 |
		/// @pnt - вектор-N
		...
		/// Точка находится внутри симплекса, если все её барицентрические координаты
