...
/**
Функция перебирает комбинации выборок неповторяющихся arrsize элементов из elements вариантов.
Левый индекс всегда меньше правого.

Количество шагов алгоритма определяется количеством сочетаний elements по arrsize.
