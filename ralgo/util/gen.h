...
namespace ralgo
{
    namespace gen
    {
        ...
        public:
            ...
            bool operator!=(const range_iterator &oth)
            {
                return val != oth.val;
            }
        };
        ...
        public:
            ...
            range(int start, int stop, int step) : _start(start), _step(step)
            {
                _size = (stop - start) / step;
            }
            ...
            {
                return range_iterator(_start, _step);
            }
            const range_iterator end() const
            {
                return range_iterator(_start + _step * _size, _step);
            }
