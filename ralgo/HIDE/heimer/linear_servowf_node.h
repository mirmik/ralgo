...
namespace heimer
{
    ...
    public:
        ...
        template <class M>
        int init(const char *name, const M &matrix,
        ...
        template <class M> void set_matrix(const M &matrix)
        {
            auto rl_transform =
                ralgo::matrix_view_co<real>{rl_transform_buffer, 0, 0};
            auto lr_transform =
                ralgo::matrix_view_co<real>{lr_transform_buffer, 0, 0};
        ...
        void provide_wish_signal(real servo_wishfeed::*fieldptr) override
        {
            ...
            ralgo::matrix_view_co<real> transform{rl_transform_buffer, sigcount,
                                                  sigcount};
        ...
        void provide_feed_signal(real servo_wishfeed::*fieldptr) override
        {
            ...
            ralgo::matrix_view_co<real> sigmat(signal_buffer, sigcount, 1);
            ralgo::matrix_view_co<real> result(result_buffer, 0, 0);
            ralgo::matrix_view_co<real> transform{lr_transform_buffer, sigcount,
                                                  sigcount};
