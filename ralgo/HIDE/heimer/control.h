...
namespace heimer
{
    ...
    public:
        ...
        virtual control_node *iterate(control_node *it) { return nullptr; }
        ...
        virtual int internal_command(int argc, char **argv) { return -1; }
    ...
    protected:
        ...
        virtual int on_external_take(control_node *master) { return 0; }

        // вызывается при отпускании внешнего управления
        virtual int on_external_release(control_node *master) { return 0; }
