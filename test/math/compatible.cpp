...
TEST_CASE("test") 
{
	...
	CHECK_EQ(ralgo::is_matrix_compatible<ralgo::transposed_matrix_proxy<ralgo::matrix<double>>>(), 1);
	CHECK_EQ(ralgo::is_matrix_compatible<ralgo::inverted_diagonal_proxy<ralgo::vector<double>>>(), 1);
