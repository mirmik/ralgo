...
TEST_CASE("angle over polyline 2") 
{
	...
	CHECK_EQ(
		polyline_over_point2_argument(polyline,8,{10,5}, true), 
		doctest::Approx(-360./180.*M_PI));

	CHECK_EQ(
		polyline_over_point2_argument(polyline,8,{15,15}, true), 
		doctest::Approx(-360./180.*M_PI));


	CHECK_EQ(
		polyline_over_point2_argument(polyline,8,{5,15}, true), 
...
TEST_CASE("angle over polyline 3") 
{
	...
	CHECK_EQ(
		point2_in_polygon({10,5}, polyline,8), true);

	CHECK_EQ(
		point2_in_polygon({15,15}, polyline,8), true);

	CHECK_EQ(
		point2_in_polygon({5,15}, polyline,8), false);
}
