...
TEST_CASE("cnc.runtest with gears assigned one")
{
    ...
    std::vector<
        ...
        points{{100ms, 0, 20},        {200ms, 40, 60},
               {300ms, 190, 200},     {400ms, 440, 450},
               {500ms, 790, 800},     {600ms, 1240, 1250},
               {700ms, 1780, 1800},   {800ms, 2440, 2460},
               {900ms, 3180, 3200},   {1000ms, 4030, 4050},
               {1100ms, 4980, 5000},  {1200ms, 5930, 5950},
               {1300ms, 6780, 6820},  {1400ms, 7530, 7550},
               {1500ms, 8180, 8200},  {1600ms, 8730, 8750},
               {1700ms, 9180, 9200},  {1800ms, 9530, 9550},
               {1900ms, 9780, 9800},  {2000ms, 9940, 10000},
               {2100ms, 10000, 10000}};
...
TEST_CASE("cnc.runtest move and stop and move")
{
    ...
    std::vector<std::tuple<std::chrono::milliseconds, cnc_float_type>> points_2{
        {2500ms, 1099}, {2600ms, 1104}, {2700ms, 1119}, {2800ms, 1143},
